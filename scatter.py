...
#if alpha is grater then zero -> stock is on avarage performing better then another
#beta is related to the slope of line fitting scatter plot -> concept of average rate between each stock
